...
HOME_URL = "http://top.baidu.com/buzz?b=344&c=513&fr=topbuzz_b1"
...
class BaiduHotEntParser(Spider):
      def __init__(self):
            super(BaiduHotEntParser, self).__init__(HOME_URL)
